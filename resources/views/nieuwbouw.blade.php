...
@section('content')
   ...
   <div class="breadcrum-section">
      <div class="container">
         <div class="row">
            <h3>Nieuwbouw</h3>
            <ul class="list">
               <li> <a href="#BENG-berekening"> BENG-berekening</a></li>
               <li> <a href="#Daglicht"> Daglicht en ventilatieberekening</a></li>
               <li> <a href="#MPG-berekening"> MPG-berekening</a></li>
               <li> <a href="#Energielabel"> Energielabel bij oplevering</a></li>
               <li> <a href="#Stikstofberekening"> Stikstofberekening</a></li>
           </ul>
         </div>
      </div>
   </div>
   ...
   <section id="BENG-berekening" class="text-contend-section" style="background-color: white;">
      <div class="container">
         <div class="row  h-100 align-items-center mt-2">
            <div class="col-lg-12">
               <h2 class="mb-3">BENG-berekenig</h2>
               <p class="pb-3">
   ...
   <section id="Daglicht" class="text-contend-section" >
      <div class="container">
         <div class="row  h-100 align-items-center mt-2">
            <div class="col-lg-12">
               <h2 class="mb-3">Daglicht en ventilatieberekening</h2>
               <p class="pb-3">
   ...
   <section id="MPG-berekening" class="text-contend-section" style="background-color: white;">
      <div class="container">
         <div class="row  h-100 align-items-center mt-2">
            <div class="col-lg-12">
               <h2 class="mb-3">MPG-berekening</h2>
               <p class="pb-3">
                  De MilieuPrestatie Gebouwen (MPG) geeft aan wat de milieubelasting is van de materialen die in een gebouw worden toegepast gedurende de volledige levenscyclus van het gebouw.  
               </p>
               <p class="pb-3">
   ...
   <section id="Energielabel" class="text-contend-section" >
      <div class="container">
         <div class="row  h-100 align-items-center mt-2">
            <div class="col-lg-12">
               <h2 class="mb-3">Energielabel bij oplevering</h2>
               <p class="pb-3">
               ...
               <p class="pb-3">
                  ...
                  Het is verplicht om bij oplevering te beschikken over een definitief energielabel,
                  de Inspectie Leefomgeving en Transport (ILT) controleert op de aanwezigheid van een geldig energielabel bij verkoop, verhuur en oplevering van (recreatie)woningen. Eigenaren die geen energielabel hebben geregistreerd, lopen de kans op een boete of een last onder dwangsom.
               </p>
   ...
   <section  id="Stikstofberekening" class="text-contend-section" style="background-color: white;">
      <div class="container">
         <div class="row  h-100 align-items-center mt-2">
            <div class="col-lg-12">
               <h2 class="mb-3">Stikstofberekening</h2>
               <p class="pb-3">
                  Een stikstofdepositieberekening voor de bouw wordt gebruikt om te bepalen hoeveel stikstof vanuit bouwactiviteiten neerdaalt op beschermde natuurgebieden. Met behulp van de AERIUS software wordt de stikstofdepositie berekend door emissies van bouwmachines, transport en andere activiteiten te analyseren. Dit is belangrijk om te bepalen of een bouwproject voldoet aan de wettelijke normen rondom stikstof en natuurbehoud. De software houdt rekening met verschillende emissiebronnen en de verspreiding van stikstof door de lucht. Bij overschrijding van de drempelwaarde zullen er maatregelen genomen moeten worden, zoals het gebruik van schonere machines.
               </p>
               <p class="pb-3">
                  Het aanleveren van een stikstofdepositie berekening kunnen een vereiste zijn bij het aanvragen van een bouwvergunning.
               </p>
