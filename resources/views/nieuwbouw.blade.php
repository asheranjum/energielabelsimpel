      ...
      <div class="container">
         <div class="row">
            ...
            <ul class="list">
               ...
               <li> <a href="#Koellastberekening"> Koellastberekening</a></li>
           </ul>
         </div>
      </div>
   </div>
   ...
   <section id="BENG-berekening" class="text-contend-section" style="background-color: white;">
      <div class="container">
         <div class="row  h-100 align-items-center mt-2">
            <div class="col-lg-12">
               <h2 class="mb-3">BENG-berekening</h2>
               <p class="pb-3">
...
Om de MPG eenvoudig en overzichtelijk te houden, worden de verschillende manieren waarop het milieu wordt belast samengevat in één waarde: de schaduwkosten van een materiaal. Dit zijn de kosten die theoretisch nodig zijn om de milieuschade als gevolg van het materiaalgebruik volledig te herstellen. </p>
   ...
   <section  id="Koellastberekening" class="text-contend-section" style="background-color: white;">
      <div class="container">
         <div class="row  h-100 align-items-center mt-2">
            <div class="col-lg-12">
               <h2 class="mb-3">Koelbehoefteberekening</h2>
               <p class="pb-3">
