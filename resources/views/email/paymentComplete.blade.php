                                             ...
                                             <tr style="border-collapse:collapse">
                                                <td align="left"
                                                   style="padding:0;Margin:0;padding-top:0px;padding-bottom:20px">
                                                    <p> Your Payment Receipt for Order #{{$details['payment_info']['order_id']}} <p>
                                                   <p
                                                      ...
                                                      Dear {{$details['billing_info']['delivery_name']}},
                                                      <br /> <br />
                                                      Thank you for your purchase from Radio Nostalgie! <br />
                                                      {{$payment_info['body']}}:
                                                   ...
                                                   <div class="">
                                                      ...
                                                      <div class="order-details">
                                                          @if($details['payment_info']['created_date'] != '')
                                                         <p><strong>Order Date:</strong> {{$details['payment_info']['created_date']}}</p>
                                                         <p><strong>Payment Method:</strong> {{$details['payment_info']['payment_method']}}</p>
                                                         <p><strong>Total Amount:</strong> {{$details['payment_info']['total']}}</p>
                                                         @endif
                                                         <p><strong>Billing Address:</strong>  {{$details['billing_info']['address']}} <br>
                                                              {{$details['billing_info']['city']}},  {{$details['billing_info']['state']}}  {{$details['billing_info']['postal']}}<br>
                                                            {{$details['billing_info']['country']}}
                                                         </p>
                                                      </div>
                                                  ...
                                                  <table class="details-table">
                                                        <tr>
                                                            <th>Product</th>
                                                            <th>SKU</th> <!-- Add this line for the SKU column -->
                                                            <th>Quantity</th>
                                                            <th>Price</th>
                                                        </tr>
                                                        <!-- Repeat this row for each item in the list of items -->
                                                        @foreach($products as $product)
                                                        <tr>
                                                            <td>{{$product->name}}</td> <!-- Remove SKU from this line -->
                                                            <td>{{$product->SKU}}</td> <!-- Add this line to display the SKU -->
                                                        ...
                                                        <!-- End of list -->
                                                        <tr>
                                                            <td colspan="3" class="total">Shipping Method:</td> <!-- Update colspan to 3 -->
                                                            <td>{{$details['payment_info']['shipping_method']}}</td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3" class="total">Subtotal:</td> <!-- Update colspan to 3 -->
                                                            <td>${{$details['payment_info']['subtotal']}} </td>
                                                        </tr>
                                                        <!--<tr>-->
                                                        ...
                                                        <!--</tr>-->
                                                        <tr>
                                                            <td colspan="3" class="total">Tax:</td> <!-- Update colspan to 3 -->
                                                            <td>${{$details['payment_info']['tax']}}</td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3" class="total">Total Paid:</td> <!-- Update colspan to 3 -->
                                                      ...
                                                      <div class="shipping-details">
                                                         ...
                                                         <p>{{$details['shipping_info']['delivery_address_1']}}<br>
                                                            {{$details['shipping_info']['delivery_address_2']}}<br>
                                                             {{$details['shipping_info']['city']}},  {{$details['shipping_info']['state']}}  {{$details['shipping_info']['postal']}}<br>
                                                            {{$details['shipping_info']['country']}}
