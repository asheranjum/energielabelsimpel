@php  $prodcuts = $details['products'] @endphp
<!DOCTYPE html
						...
						<tr style="border-collapse:collapse">
							<td align="center" style="padding:0;Margin:0">
								<table class="es-header-body"
									style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#c3cf3d;width:600px"
									cellspacing="0" cellpadding="0" bgcolor="#044767" align="center">
									<tr style="border-collapse:collapse">
										<td align="center"
											style="Margin:0;padding-top:35px;padding-bottom:35px;padding-left:35px;padding-right:35px; font-size: 30px; color: white; font-weight: 500;">
												...
												<tr style="border-collapse:collapse">
													<td valign="top" align="center"
														...
														<table width="100%" cellspacing="0" cellpadding="0"
															...
															<!-- <tr style="border-collapse:collapse">
																<td align="center"
																	style="Margin:0;padding-top: 0px;padding-bottom:25px;padding-left:35px;padding-right: 35px;font-size:0">
																	<a target="_blank" href="#"
																		style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#ED8E20;font-size:16px"><img
																			src="https://sfpxay.stripocdn.email/content/guids/CABINET_75694a6fc3c4633b3ee8e3c750851c02/images/67611522142640957.png"
																			alt
																			style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
																			width="90" height="85"></a>
																</td>
															</tr> -->
															<!-- <tr style="border-collapse:collapse">
																<td align="center"
															...
															<tr style="border-collapse:collapse">
																<td align="left"
																	style="padding:0;Margin:0;padding-top:0px;padding-bottom:20px">
																	<p
                                                                    ...
                                                                    <h2 style="display:block;font-size:16px;font-weight:bold;margin:18px 0 0px;text-align:left">
																		Date Created :  {{$details['created_date']}}</h2>
																	...
																	<table
																		...
																		<tr style="border-collapse:collapse">
																			<td style="padding:5px 10px 5px 0;Margin:0"
																				...
																				<p
																					style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;font-size:14px">
																					{{$product->name}} -- {{$product->SKU}}  ({{$product->quantity}})</p>
																					
																				<div style="margin-top:10px">
    <h6>
        @if(isset($product->addOnsPrice) && $product->addOnsPrice > 0 || isset($product->addOns3dPrice) && $product->addOns3dPrice > 0)
...
<ul style="font-size:12px">
    ...
    @if(isset($product->warranty))
        <li><span>{{ isset($product->warranty->name) ? $product->warranty->name : 'Warranty' }} : ${{ number_format($product->warranty->price, 2) }}</span></li>
    @endif
</ul>
																	...
																	<table
																		...
																		<tr style="border-collapse:collapse">
																			...
																			<td width="20%" style="padding:0;Margin:0">
																				<h4
																					style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif">
																					${{ number_format($details['total'],2)}}</h4>
																			</td>
																		</tr>
																	</table>
																</td>
														...
														<table width="100%" cellspacing="0" cellpadding="0"
															...
															<tr style="border-collapse:collapse">
																<td align="left" style="padding:0;Margin:0;padding-bottom:10px">
                                                                     @if($details['delivery_name'] != "")<p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;font-size:14px"> {{$details['delivery_name']}}</p> @endif
																	<!--@if($details['delivery_company'] != "")<p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;font-size:14px">{{$details['delivery_company']}}</p> @endif-->
                                                                    @if($details['delivery_address_1'] != "")<p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;font-size:14px">{{$details['delivery_address_1']}}</p>  @endif
																	@if($details['delivery_address_2'] != "")<p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;font-size:14px">{{$details['delivery_address_2']}}</p>  @endif
																	@if($details['delivery_contact_no'] != "")<p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;font-size:14px">{{$details['delivery_contact_no']}}</p>  @endif
																	@if($details['delivery_email'] != "")<p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;font-size:14px">{{$details['delivery_email']}}</p>  @endif
																</td>
															</tr>
														...
														<table width="100%" cellspacing="0" cellpadding="0"
															...
															<tr style="border-collapse:collapse">
																<td align="left" style="padding:0;Margin:0">
																	<p
																		style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;font-size:14px">
																		 Estimated Delivery Times are From 8 to 12 Weeks From the Day of Purchase</p>
																</td>
															</tr>
														</table>
													</td>
						...
						<tr style="border-collapse:collapse">
							<td align="center" style="padding:0;Margin:0">
								<table class="es-footer-body" cellspacing="0" cellpadding="0" align="center"
									...
									<tr style="border-collapse:collapse">
										<td align="left"
											style="Margin:0;padding-top:35px;padding-left:35px;padding-right:35px;padding-bottom:40px; background-color: #c3cf3d;">
											<table width="100%" cellspacing="0" cellpadding="0"
												style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
												<tr style="border-collapse:collapse">
													<td valign="top" align="center"
														...
														<table width="100%" cellspacing="0" cellpadding="0"
															...
															<tr style="border-collapse:collapse">
																<td align="center"
																	...
																	<a href="{{ env('FRONTEND_URL') }}" target="_blank" rel="noopener noreferrer">
																	<img src="{{ url('storage/settings/April2024/5YZLCd8FW2x7Sxmfx0oI.png') }}"
																		alt="logo"
															...
															<tbody>
																<tr>
																	<td align="center" valign="top" class="es-p10r">
																		<a target="_blank" href="https://web.facebook.com/www.radionostalgie.cz">
														...
														<table cellpadding="0" cellspacing="0" class="es-table-not-adapt es-social">
															<tbody>
																<tr>
																	<td align="center" valign="top" class="es-p10r">
																		<!--<p style="color: white;">-->
																		<!--	Louis Street Doveton Victoria 3177 Australia-->
																		<!--</p>-->
																	</td>
